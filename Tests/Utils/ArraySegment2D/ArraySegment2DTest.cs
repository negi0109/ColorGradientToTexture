...
namespace Negi0109.ColorGradientToTexture.Utils.Tests
{
    namespace ArraySegment2DTest
    {
        public class ArraySegment2DBaseTest
        {
            ...
            {
                var seeker = new ArraySegment2DStub(s0, s1).Dimension(1);
            ...
            {
                var seeker = new ArraySegment2DStub(s0, s1).Backward();
            ...
            public class Integrations
            {
                ...
                {
                    var seeker = new ArraySegment2DStub(s0, s1).Dimension(1).Backward();
